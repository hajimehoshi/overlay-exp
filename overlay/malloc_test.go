...
func TestArenaCollision(t *testing.T) {
	t.Skip("this test doen't make sense in an environment where we cannot allocate at a specified address. See golang/go#49415")
	...
	for i := 0; i < 5; i++ {
		...
		println("start, end, ", unsafe.Pointer(start), unsafe.Pointer(end))
